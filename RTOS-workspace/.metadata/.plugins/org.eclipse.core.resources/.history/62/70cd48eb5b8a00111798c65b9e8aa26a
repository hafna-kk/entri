...
/* USER CODE BEGIN PFP */
static void green_led_handler(void * pvParameters);
static void blue_led_handler(void * pvParameters);
static void red_led_handler(void * pvParameters);
/* USER CODE END PFP */
...
int main(void)
{
  ...
  xReturned = xTaskCreate(
		  	  	  	  green_led_handler,       /* Function that implements the task. */
                      "Green LED Task",          /* Text name for the task. */
                      100,      /* Stack size in words, not bytes. */
                      "Green",    /* Parameter passed into the task. */
  ...
  xReturned = xTaskCreate(
		  	  	  	  blue_led_handler,       /* Function that implements the task. */
                      "Blue LED Task",          /* Text name for the task. */
                      100,      /* Stack size in words, not bytes. */
                      "Blue",    /* Parameter passed into the task. */
                      2,/* Priority at which the task is created. */
  ...
  xReturned = xTaskCreate(
		  	  	  	  red_led_handler,       /* Function that implements the task. */
                      "Red LED Task",          /* Text name for the task. */
                      100,      /* Stack size in words, not bytes. */
                      "Red",    /* Parameter passed into the task. */
                      2,/* Priority at which the task is created. */
